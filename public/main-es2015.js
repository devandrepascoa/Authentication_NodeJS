...
const routes = [
    ...
    { path: 'profile', component: _components_profile_profile_component__WEBPACK_IMPORTED_MODULE_5__["ProfileComponent"], canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_8__["AuthGuard"]] },
...
let DashboardComponent = class DashboardComponent {
    constructor(authService, validateService, flashService, router) {
...
let NavbarComponent = class NavbarComponent {
    constructor(authService, flashService, router) {
        this.authService = authService;
        this.flashService = flashService;
        this.router = router;
    }
...
let AuthService = class AuthService {
    ...
    getProfile() {
        this.loadToken();
        let headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set('Authorization', this.authToken);
        console.log(headers);
...
module.exports = __webpack_require__(/*! C:\Users\andrepascoa\Desktop\authentication\angular-src\src\main.ts */"./src/main.ts");
